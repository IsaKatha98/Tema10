...
public class Main {
	...
	public static void main(String[] args)
		...
		try {
			...
			System.out.print("Introduzca un número de horas válido y pulse Intro: ");
			hora = sc.nextInt();
		...
		try {
			...
			System.out.print("Introduzca un número de minutos válido y pulse Intro: ");
			min = sc.nextInt();
		...
		try {
			...
			System.out.print("Introduzca un número de segundos válido y pulse Intro: ");
			seg= sc.nextInt();
